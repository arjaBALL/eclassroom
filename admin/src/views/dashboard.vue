...
#item-2 {
  ...
  height: calc(100vh - 4em); /* Ensures correct height */
  border-left: 1px solid #959baa;
  transition: all 0.3s ease;
}
...
#item-2 {
  ...
  grid-template-areas:
    "box0 box0 box1 box1 box2 box2 box2 box2"
    "box0 box0 box1 box1 box2 box2 box2 box2"
    "box3 box3 box3 box3 box2 box2 box2 box2"
    "box3 box3 box3 box3 box2 box2 box2 box2"
    "box4 box4 box4 box4 box4 box4 box4 box4"
    "box4 box4 box4 box4 box4 box4 box4 box4"
    "box5 box5 box5 box6 box6 box6 box6 box6"
    "box5 box5 box5 box6 box6 box6 box6 box6";
  gap: 0.5em;
  padding: 8px;
}
